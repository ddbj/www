...
Data files cannot be added to the archived Run. In another DRA
submission, create new Experiment-Run objects referencing existing
BioProject and BioSample records to add data files.

Similar to Run, data files cannot be added to the archived
...
{% include image.html url="books/add_data_files.jpg" caption="Add a sample and a data file to existing BioProject" class="w400" %}

{% include image.html url="books/add_run.jpg" caption="Add a data file to existing BioProject and BioSample" class="w400" %}
