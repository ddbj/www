...
特許出願に含まれる塩基配列データを表す[アクセッション番号]({{ site.baseurl }}/services/documents/accessions.html) は [プレフィックス]({{ site.baseurl }}/services/documents/documents/documents/prefix.html) で識別可能です。
