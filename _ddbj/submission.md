...
## 塩基配列登録の前に <a name="responsibility"></a>

### 塩基配列登録の目的と意義 <a name="purpose"></a>
...
登録者は自身の研究の進展・異動、または、誤りを正すなどの理由により、自身が登録した[塩基配列と登録情報を修正・更新](/ddbj/updt.html)することができます。
...
## 塩基配列データの登録に必要な情報 <a name="item"></a>

### 登録者の情報 <a name="submitter_info"></a>
...
### 論文、REFERENCE <a name="reference"></a>
...
## 塩基配列登録の流れ <a name="workflow"></a>

### 1.塩基配列登録受付 <a name="accept"></a>
...
### 3.アクセッション番号の発行と通知 <a name="accession number"></a>
...
### 5.登録、公開について連絡先一覧 <a name="information"></a>
...
<ol>
  ...
  <li>
    配列登録<br>
    基本的には、DDBJ への登録は <a href="/ddbj/websub.html">塩基配列登録システム</a>、または、<a href="/ddbj/mss.html">Mass Submission System</a>
  ...
  <li>
    ...
    登録時に即時公開を指定された場合は、作業完了後、すぐに公開いたします。公開予定日
      が指定された場合は、<a href="/data-release-policy.html">公開原則</a>に基づき公開されます。論文出版などによるアクセッション番号の公表が確認された場合は例外なく公開します。また「アクセッション番号の公表」に基づく公開請求は、誰にでも可能です。
    </li>
  <li>
    公開データの利用<br>
  ...
  <li>
    公開データへのフィードバック<br>
    公開されたデータに対する質問・確認などは登録者へお願いいたします。連絡先が不明な場合は転送いたしますので、<a href="/contact.html" >お問い合わせフォーム</a>からご連絡ください。
  </li>
  <li>
    データ更新の権限<br>
