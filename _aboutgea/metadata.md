...
{::nomarkdown}
{% include image.html url="magetab/magetab_over.jpg" caption="IDF，SDRF，ADFと生データファイル，解析処理されたデータファイル間の関係" class="w600" %}
{:/}
...
{::nomarkdown}
{% include image.html url="magetab/sdrf.jpg" caption="SDRF の全体構造" class="w600" %}
{:/}
