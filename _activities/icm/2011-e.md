...
BioProject database  
:  [Since 2005](/activities/index-e.html#2005), INSDC has discussed project ID assignment as a flag to specify not only genomic and metagenomic sequencing projects but also many kinds of biological projects with considerable modifications.  
...
-   Implementation of /whole\_replicon was cancelled.  
    At [ICM2010](/activities/index-e.html#2010), we were to flag
