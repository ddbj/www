...
INSDC Data Status  
:  We discussed practical procedures about data exchange among databanks, especially, [INSDC status](/insdc-status-e.html), [replaced](/insdc-status-e.html#replaced) data between databanks and [suppressed](/insdc-status-e.html#suppressed) data of SRA.

[Assembly](https://www.ncbi.nlm.nih.gov/assembly/) (Genomic Collection)  
:  To enhance the collaboration with Assembly since [2012](/activities/icm-reports-e.html#2012), we discussed some practical issues.
