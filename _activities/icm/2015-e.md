...
Handling Human Data  
:  Following kind introduction of recent activities at [NIH](https://www.nih.gov/); [HeLa access](https://grants.nih.gov/grants/guide/notice-files/NOT-OD-14-080.html), [Genomic Data Sharing (GDS)](http://gds.nih.gov/) policy, [data analysis on cloud computing](https://grants.nih.gov/grants/guide/notice-files/NOT-OD-15-086.html) and so on, we discussed how to treat data submissions derived from human subjects at each databank.

INSDC Data Status  
:  We discussed practical procedures about data exchange among databanks, especially, [INSDC status](/about/insdc-status-e), [replaced](/about/insdc-status-e#replaced) data between databanks and [suppre/insdc/insdc-status-e#suppressed) data of SRA.

[Assembly](https://www.ncbi.nlm.nih.gov/assembly/) (Genomic Collection)  
:  To enhance the collaboration with Assembly since [2012](/activities/icm/2012-e), we discussed some practical issues.
...
:  Following an academic paper, [Federhen S (2015)](https://nar.oxfordjournals.org/content/43/D1/D1086), and [GenBank microbial genomic taxonomy workshop (12-13 May 2015)](https://standardsingenomics.biomedcentral.com/articles/10.1186/s40793-016-0134-1), we discussed how to resolve the problem of misidentified genomes.

#### Forthcoming changes in The DDBJ/EMBL/GenBank Feature Table: Definition  {#2015-ft}

The following items will be applied from October 2015 with the next
revision of [Feature Table Definition](/ddbj/feature-table-e.html), if not
otherwise specified.
...
-   [Since 2013](/activities/icm/2013-e), a new qualifier,
