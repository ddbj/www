...
:  taxonomy database では、微生物のゲノム全長規模の登録に関して、strain
  level taxonomy ID を割り当てる運用を廃止する方向で[2009年](/activities/icm/2009)から 検討しています。
...
#### Feature と Qualifier の記載則改訂  {#2012-ft}
...
-   規定値を持つ qualifier について、その規定値の改訂は [INSDC の web
    ...
    Table Definition](/ddbj/feature-table.html)
