...
:  The BioSample database contains descriptions of biological source materials used in experimental assays.  
  ...
  Following the meetings on [2012](/activities/index-e.html#2012) and [2013](/activities/index-e.html#2013), we discussed action items to collect and to share BioSample data at INSDC.
...
:  Following the meeting on [2012](/activities/index-e.html#2012), we continues collaboration with Assembly activities to collect genome sequences.
