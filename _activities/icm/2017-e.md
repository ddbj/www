...
We also hold [a symposium]({{ site.baseurl }}/assets/files/pdf/30th/NIG_and_DDBJ_Symposium-e.pdf)
...
:  Since [2016](/activities/icm/2016-e), INSDC has started to accept [TLS](/ddbj/tls-e.html) data.   After discussion about some practical issues at the meeting, DDBJ will start accepting TLS data submission.
...
:  To enhance the collaboration with Assembly since [2012](/activities/icm/2012-e), we discussed some practical issues.  Related to this, we confirmed that we should caution during sequence submissions when the sizes of genome sequences were deviated from the closely related species.

#### Forthcoming Changes in The DDBJ/ENA/GenBank Feature Table: Definition  {#2017-ft}

The following items were proposed to be applied for [Feature Table
Definition](/ddbj/feature-table-e.html) from the next revision.
...
-   Addition of some controlled vocabularies for
    [/type\_material](/ddbj/feature-table-e.html#type_material) qualifier.
