...
INSDC Data Status  
:  We discussed practical procedures about data exchange among databanks, especially, [INSDC status](/about/insdc-status-e) for bulk data like [WGS](/ddbj/wgs-e.html) and [TSA](/ddbj/tsa-e.html) and also for SRA, BioProject and BioSample records.
...
#### Forthcoming Changes in The DDBJ/ENA/GenBank Feature Table: Definition  {#2016-ft}

The following items were proposed to be applied for [Feature Table
Definition](/ddbj/feature-table-e.html) from the next revision or later.
...
-   /recombination\_class qualifier for
    [misc\_recomb](/ddbj/feature-table-e.html#misc_recomb) feature
