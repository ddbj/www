...
title: '34th ICM: May 10-14 2021, teleconference'
...
#### Formalising INSDC 
For more formalising INSDC partnership, we discussed about Memorandum of of Agreement.    
We also discussed about common licensing for data providing and posibility of apllication of 
...
-   For future submissions, we will no longer use /citation と /compare qualifiers.  
...
-   The terms, "recombination_enhancer" and "uORF (or regulatory_uORF)" will be added to controlled vocabularies for [/regulatory_class](/ddbj/qualifiers-e.html#regulatory_class) qualifier.    
