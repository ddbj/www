...
INSDC のパートナー関係をより正式なものにするために合意書 (MOA) について検討しました。    
提供するデータのライセンスについて共通化、[CC0](https://creativecommons.jp/sciencecommons/aboutcc0/) 適用の可能性について議論しました。

#### 新型コロナウイルスの影響とそのデータ共有  

新型コロナウイルスのデータ共有は INSDC の重要な課題と考えています。    
SARS-CoV-2 配列の登録受付に関する技術的な問題について議論しました。    
[2020 年](/activities/insdc_meeting/2021.html) から引き続き、SARS-CoV-2 配列データを INSDC データベースに登録することを奨励しています。    
