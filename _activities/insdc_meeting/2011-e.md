...
<a name="bioproject"></a>
BioProject database  
:  [Since 2005](/activities/insdc_meeting/2005-e), INSDC has discussed project ID assignment as a flag to specify not only genomic and metagenomic sequencing projects but also many kinds of biological projects with considerable modifications.  
...
-   Improvement of pseudogene annotation  
    ...
    report](/activities/insdc_meeting/2010-e), Prokaryotic Annotation
    Workshop requested INSDC to improve its pseudogene annotation. Also,
    to solve [a problem of /pseudo qualifier usage in
    ICM2009](/activities/insdc_meeting/2009-e), we discussed and
...
-   Implementation of /whole\_replicon was cancelled.  
    At [ICM2010](/activities/insdc_meeting/2010-e), we were to flag
