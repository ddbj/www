...
本規約において使用する以下の用語は、各々以下に定める意味を有します。
  ...
  - 「センター」とは、大学共同利用機関法人情報・システム研究機構国立遺伝学研究所バイオデータ研究拠点のことをいいます。
...
### 一般規定 {#general-regulations}
  1. 大学共同利用機関法人情報・システム研究機構　国立遺伝学研究所バイオデータ研究拠点（以下、「センター」といいます。）はウェブサイト、検索・解析サービス、データベースサービス（以下、「オンラインサービス」といいます。）やスーパーコンピュータを提供することで生命科学研究をサポートしています（以下、センターの提供するこれらのサービスを総称して「本サービス」といいます。）。本サービスの利用を開始した場合（以下、本サービスを利用した者を「利用者」といいます。）、利用者は、以下に定める利用規約に同意したものとみなされるものとします。また、本サービス中、個別に規約が定められている（以下「個別規約」といいます。）サービスの利用にあたっては本規約に加えて、当該サービスの個別規約が優先して適用されます。
  ...
  1. 利用者は適用される法令、規則、ガイドラインその他の規範を遵守するものとします。これには、個人情報・プライバシー保護、知的財産権、遺伝資源へのアクセスと利益配分、輸出管理、経済制裁に関するものを含みます。
...
センターが提供するデータは個別規約で制限されていない限り、自由に利用・再配布・改変することができます。
  ...
  1. [INSDC](/insdc.html) データには、第三者の特許権、著作権、その他の知的財産権、遺伝資源へのアクセスと利益配分に関する権利等により、利用条件が定められているものが含まれる場合があります。利用者は、自己の責任において、適用される条件を確認し、遵守するものとします。
...
　
センターが利用している第三者が運営するサイトは「[ソーシャルメディアにおけるバイオデータ研究拠点のオフィシャルサイト](#third-party-sites)」を参照してください。
...
これはバイオデータ研究拠点（以下、「センター」）が運営するデータベースへデータを登録するためのガイドラインであり、データ登録者の権利、および、守るべき事項を述べています。
...
原則として個人識別符号に該当するゲノムデータが、データベースを通じて制限なく一般公開されることについて同意を受けている必要があります。
...
利用者は、バイオデータ研究拠点（以下、「センター」）が提供するウェブサイトのコンテンツ、サービスやデータを利用した場合において、適切なクレジットをセンター及び提供者に対して付与しなくてはなりません。
...
### バイオデータ研究拠点自体の引用 {#credit-for-center}
利用者が、バイオデータ研究拠点自体を引用する場合は、[センターの活動全般に関する最新論文](/references.html#ddbj)を引用してください。
...
## バイオデータ研究拠点が提供するセンター以外で作成されたデータの利用 {#third-party-data}
バイオデータ研究拠点が FTP によるダウンロードや各サービスで二次的に提供しているデータの利用については、以下からリンクしている利用規定に準拠します。
...
## ソーシャルメディアにおけるバイオデータ研究拠点のオフィシャルサイト    {#third-party-sites}
バイオデータ研究拠点のソーシャルメディアにおけるオフィシャルサイト（アカウント）は以下になります。
