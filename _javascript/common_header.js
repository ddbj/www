(()=>{
  ...
  const BOTTOM_MENU = {
    SITEMAP: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            label: {
              en: 'Sequence Read Archive (DRA)',
              ja: 'Sequence Read Archive (DRA)'
            },
            desc: {
              en: 'Sequence Read Archive',
              ja: 'Sequence Read Archive'
    ...
    INFORMATION: [
      ...
      },
      {
        ...
        uri: {
          en: 'https://www.facebook.com/ddbjcenter/',
          ja: 'https://www.facebook.com/ddbjcenter/'
        },
        logo: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40"><defs><style>.cls-1{fill:#3b5998;}</style></defs><path id="f" class="cls-1" d="M22.36,30.53V19.77H26l.54-4.2H22.36V12.89c0-1.21.34-2,2.08-2h2.22V7.1a29.39,29.39,0,0,0-3.23-.17c-3.21,0-5.4,2-5.4,5.55v3.09H14.41v4.2H18V30.53Z"/></svg>'
      },
      {
        label: {
          en: 'DDBJ on Youtube',
        ...
        desc: {
          en: 'Introduction of DDBJ by Youtube videos',
          ja: '動画で DDBJ を解説'
        },
        uri: {
          en: 'https://www.youtube.com/user/ddbjvideo',
          ja: 'https://www.youtube.com/user/ddbjvideo'
        },
        logo: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40"><defs><style>.cls-1{fill:#cf2200;}</style></defs><path class="cls-1" d="M34,19.89a36.59,36.59,0,0,1-.59,6.78,3.45,3.45,0,0,1-2.47,2.44C28.75,29.7,20,29.7,20,29.7s-8.75,0-10.93-.59A3.45,3.45,0,0,1,6.6,26.67,36.59,36.59,0,0,1,6,19.89a36.59,36.59,0,0,1,.59-6.78,3.5,3.5,0,0,1,2.47-2.48C11.25,10,20,10,20,10s8.75,0,10.93.59a3.5,3.5,0,0,1,2.47,2.48A36.59,36.59,0,0,1,34,19.89Zm-9.54,0-7.31-4.16v8.32Z"/></svg>'
      },
      {
        label: {
          en: 'DDBJ on GitHub',
        ...
        logo: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40"><defs><style>.cls-1{fill-rule:evenodd;}</style></defs><path class="cls-1" d="M20,6.77a12.89,12.89,0,0,0-4.07,25.11c.64.12.88-.28.88-.62s0-1.32,0-2.4c-3.58.78-4.34-1.52-4.34-1.52A3.46,3.46,0,0,0,11,25.45c-1.17-.8.09-.78.09-.78a2.7,2.7,0,0,1,2,1.33,2.74,2.74,0,0,0,3.75,1.07,2.75,2.75,0,0,1,.82-1.72C14.79,25,11.78,23.92,11.78,19a5,5,0,0,1,1.33-3.46,4.58,4.58,0,0,1,.12-3.41s1.08-.34,3.55,1.32A12.32,12.32,0,0,1,20,13a12.45,12.45,0,0,1,3.23.43c2.46-1.66,3.54-1.32,3.54-1.32a4.58,4.58,0,0,1,.12,3.41A5,5,0,0,1,28.22,19c0,4.95-3,6-5.88,6.36a3.08,3.08,0,0,1,.87,2.38c0,1.73,0,3.11,0,3.54s.23.74.88.62A12.89,12.89,0,0,0,20,6.77Z"/><path d="M12,25.27a.17.17,0,0,1-.22,0c-.1,0-.15-.13-.12-.2a.17.17,0,0,1,.22,0c.1.05.15.13.12.2Z"/><path d="M12.52,25.85c-.06.06-.18,0-.27-.06s-.1-.21,0-.27a.2.2,0,0,1,.26.06.2.2,0,0,1,0,.27Z"/><path d="M13,26.59c-.08.06-.21,0-.29-.11a.23.23,0,0,1,0-.31c.08-.05.21,0,.29.11s.08.26,0,.31Z"/><path d="M13.72,27.31c-.07.08-.22.06-.33,0a.25.25,0,0,1-.07-.33c.07-.08.22-.06.33.05s.15.25.07.33Z"/><path d="M14.68,27.72c0,.11-.17.15-.32.11s-.24-.16-.21-.27.17-.15.32-.1.24.16.21.26Z"/><path d="M15.74,27.8c0,.11-.12.2-.28.2s-.28-.08-.28-.19.12-.19.28-.2.28.09.28.19Z"/><path d="M16.72,27.63c0,.11-.09.21-.24.24s-.29,0-.31-.14.09-.21.24-.24.29,0,.31.14Z"/></svg>'
      },
      {
        label: {
          en: 'DDBJ on Google Drive',
          ja: 'DDBJ on Google Drive'
        },
        desc: {
          en: 'Report and presentation documents',
          ja: '報告書やプレゼン資料'
        },
        uri: {
          en: 'https://drive.google.com/drive/u/2/folders/1E0cxLbWV8RGYUdNs0oKfXMij0TzJDQVD',
          ja: 'https://drive.google.com/drive/u/2/folders/1E0cxLbWV8RGYUdNs0oKfXMij0TzJDQVD'
        },
    ...
    PARTNERS: [
      ...
      },
      {
        ...
        uri: {
          en: 'https://biosciencedbc.jp/en/',
          ja: 'https://biosciencedbc.jp/'
        },
        width: 97,
  ...
  #DDBJCommonBottomMenu > .DDBJ_inner, #DDBJCommonFooter > .DDBJ_inner {
    margin: 0 auto;
    max-width: 128rem;
    max-width: 1280px;
  }
  #DDBJCommonBottomMenu > .DDBJ_inner.-stretched, #DDBJCommonFooter > .DDBJ_inner.-stretched {
    max-width: 100%;
  }
  ...
  #DDBJCommonBottomMenu > .DDBJ_inner > .DDBJ_partners > ul > li + li {
    margin-left: 30px;
  }
  
  #DDBJCommonFooter {
    text-align: center;
    background-color: rgba(28, 27, 25, 0.8);
  }
  ...
  @media screen and (max-width: 480px) {
    ...
    #DDBJCommonFooter > .DDBJ_inner > .DDBJ_links > ul > li > a, #DDBJCommonFooter > .DDBJ_inner > .DDBJ_links > ul > li > address > a {
      display: block;
      padding: 8px 20px;
    }
  }
  ...
  function DDBJ_makeFooter() {
    ...
    if (script.dataset.bottomMenu !== 'false') {
      const bottomMenu = document.createElement('div');
      bottomMenu.id = 'DDBJCommonBottomMenu';
      bottomMenu.innerHTML = `<div class="DDBJ_inner">
        <nav class="DDBJ_sitemap">
          ${BOTTOM_MENU.SITEMAP.map(group => `<div class="DDBJ_group">
            <h2 class="DDBJ_title">${group.title[language]}</h2>
            <ul>
              ${group.items.map(item => `<li>
                <a title="${item.desc[language]}" href="${item.uri[language]}">${item.label[language]}</a>
              </li>`).join('')}
            </ul>
          </div>`).join('')}
        </nav>
        <nav class="DDBJ_information">
          <ul>
            ${BOTTOM_MENU.INFORMATION.map(item => `<li>
              <a ${item.desc ? `title="${item.desc[language]}"`: ''} href="${item.uri[language]}">
                ${item.logo ? `<img src="data:image/svg+xml;utf8,${encodeURIComponent(item.logo)}" alt="${item.label[language]}">` : item.label[language]}
              </a>
            </li>`).join('')}
          </ul>
        </nav>
        <nav class="DDBJ_partners">
          <ul>
            ${BOTTOM_MENU.PARTNERS.map(item => `<li>
              <a href="${item.uri[language]}">
                <img src="data:image/svg+xml;utf8,${encodeURIComponent(item.logo)}" alt="${item.label[language]}" width="${item.width}">
              </a>
            </li>`).join('')}
          </ul>
        </nav>
    ...
    // generate footer
    if (script.dataset.footer !== 'false') {
      const footer = document.createElement('footer');
      footer.id = 'DDBJCommonFooter';
      footer.innerHTML = `<div class="DDBJ_inner">
        <nav class="DDBJ_links">
          <ul>
            ${FOOTER_MENU.map(item => `<li>
              ${item.label.en === 'Address' ? '<address>' : ''}
              <a title="${item.desc[language]}" href="${item.uri[language]}">${item.label[language]}</a>
              ${item.label.en === 'Address' ? '</address>' : ''}
            </li>`).join('')}
          </ul>
