...
2. 当該[アクセッション番号](/insdc/accessions.html)の公表を確認した場合
...
### 「データ公開」についての注意事項   {#note}

公開予定日が必要な理由
:   DDBJ は登録を受け付けたデータは最終的には公開され共有されるべきであるという立場を取っています。  
    ...
    DDBJ が登録者に公開予定日の設定をお願いする理由は、登録されたデータが公開されないまま放置されることを避けるためです。  
...
:   登録データの取り扱いについては、[INSDC
    のポリシー](/insdc/index.html#policy)をご覧ください。
:   \[FAQ\]
