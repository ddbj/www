...
### WinSCP によるアップロード<a name="upload-excel-winscp"></a>
...
## データファイルのアップロード <a name="upload-data-files"></a>
...
### データファイルのアップロード<a name="data-files-upload"></a>
...
## メタデータとデータの登録<a name="metadata-data-submission"></a>
