...
<p><a href="/about/insdc-e.html#insd">INSD; International Nucleotide Sequence Database</a> are composed of DDBJ, ENA and NCBI, and collect experimentally determined nucleotide sequence data. <br>A unique <strong>accession number</strong> issued by INSD for each submitted sequence data is defined as <a href="/documents/accessions.html">the INSD accession number</a>. <br>On <a href="/ddbj/flat-file-e.html">DDBJ flat file</a>, the accession number is described in <a href="/ddbj/flat-file-e.html#AccessionB">ACCESSION</a> line. </p>
...
<dl><dt>References</dt>
  <dd><a href="/services/getentry-e.html">getentry HELP</a></dd>
  <dd><a href="/about/insdc-status-e">INSDC Status Document</a>: Replaced</dd>
