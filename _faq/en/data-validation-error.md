...
<div class="faq_list">
  <div id="length" class="faq">
    ...
    <p class="answer"><a href="/dra/services/index.html#Spot_Length">Spot length</a> value in Experiment differs from actual read length. For paired library, enter a sum of paired read lengths in the Spot length.</p>
  </div>
  <div id="fastq" class="faq">
    ...
    <p class="answer">When 'fastq' is selected for the <a href="/dra/services/index.html#File_Type">filetype</a> in Run, "read length should be constant" and "paired reads must appear in the same order in the paired files". If the fastq files do not meet these conditions, validation errors occur. Revise the <a href="/dra/services/index.html#File_Type">filetype</a> from 'fastq' to 'generic_fastq'.</p>
  </div>
  ...
  <div id="md5" class="faq">
    ...
    <p class="answer">The <a href="/dra/services/index.html#Supplement__MD5">md5 values</a> in Run differs from actual md5. Check "files are not corrupted" and "md5 values in Run are not wrong".</p>
  </div>
</div>
