...
[DDBJ アカウント](https://accounts.ddbj.nig.ac.jp) で新規作成したアカウントは即時に sftp で利用可能になりますが、D-way/JGA で利用できるようになるまで15分程かかります。ご注意ください。
...
ユーザホーム直下の `.ssh/config` ファイルで設定を追加することで、コマンド毎に指定する必要がなくなります。
