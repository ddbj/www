import{w as p,b as S,r as y,L as w,$ as l,m as d,s as D,e as B,t as b,y as A,a as R,l as v,n as q}from"./submission-wizard-ca2635b5.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class u extends f{constructor(e){if(super(e),this.it=p,e.type!==P.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===p||e==null)return this.ft=void 0,this.it=e;if(e===S)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.ft;this.it=e;const s=[e];return s.raw=s,this.ft={_$litType$:this.constructor.resultType,strings:s,values:[]}}}u.directiveName="unsafeHTML",u.resultType=1;const M=c(u);class x extends f{render(){}update(e){e.element.scrollTo({top:0,left:0,behavior:"instant"})}}var T=c(x),k={"q1-yes->g-jga":{sections:[{title:{en:"Overview",ja:"\u6982\u8981"},body:{en:`<p>Submit human genetic and phenotypic data requiring controlled-access to the <a href="/jga/submission-step-e.html">Japanese Genotype-phenotype Archive (JGA)</a>. You need to submit a data submission application to the <a href="https://humandbs.biosciencedbc.jp/en/data-submission">NBDC</a> and the application needs to be approved before submitting the data to JGA. Regarding submission and sharing of human data, see the <a href="/policies-e.html#submission-of-human-data">Data submission of human subjects research</a>.</p>
<ol>
...
<p><a href="/ddbj/wgs.html#flat-file">4\u6587\u5B57\u30D7\u30EC\u30D5\u30A3\u30C3\u30AF\u30B9\u30688\u6841\u306E\u6570\u5B57\u304B\u3089\u6210\u308B\u30A2\u30AF\u30BB\u30C3\u30B7\u30E7\u30F3\u756A\u53F7</a> (\u4F8B ZZZZ01000001) \u304C WGS \u914D\u5217\u306B\u767A\u884C\u3055\u308C\u307E\u3059\u3002</p>
...
`,ja:""}},{title:{en:"MSS",ja:"MSS"},body:{en:`<p>Submit draft genome sequences of eukaryotes as <a href="/ddbj/wgs-e.html">WGS (Whole Genome Shotgun) genomes</a> to <a href="/ddbj/index-e.html">DDBJ</a> through the <a href="/ddbj/mss-e.html">Mass Submission System (MSS)</a>. Include organellar sequences with the genome submission.</p>
<p>In the MSS submission, you will need to:
<ul>
  <li>Provide a BioProject and a BioSample that have been registered for the WGS submission. A WGS genome must be linked to a BioProject and a BioSample.</li>
  <li>Annotation is optional but required for species whose genome has not been reported. If you submit a WGS genome with annotation, it must contain the locus tag prefix so that genes are uniquely identifiable. Register the <a href="/ddbj/locus_tag-e.html">locus tag prefix</a> in the BioSample submission.</li>
...
`,ja:""}},{title:{en:"MSS",ja:"MSS"},body:{en:`<p>Submit draft genome sequences of prokaryotes as <a href="/ddbj/wgs-e.html">WGS (Whole Genome Shotgun) genomes</a> to <a href="/ddbj/index-e.html">DDBJ</a> through the <a href="/ddbj/mss-e.html">Mass Submission System (MSS)</a>. Include plasmid sequences with the genome submission.</p>
<p>In the MSS submission, you will need to:
<ul>
  <li>Provide a BioProject and a BioSample that have been registered for the WGS submission. A WGS genome must be linked to a BioProject and a BioSample.</li>
...
`,ja:""}},{title:{en:"NSSS",ja:"NSSS"},body:{en:`<p>Submit small-scale (less than 500 sequences and/or shorter than 500kb) plasmid sequences to <a href="/ddbj/index-e.html">DDBJ</a> through the <a href="/ddbj/web-submission-e.html">Nucleotide Sequence Submission System (NSSS)</a>.</p>
...
`,ja:""}},{title:{en:"MSS",ja:"MSS"},body:{en:`<p>Submit large-scale (more than 500 sequences and/or longer than 500kb) plasmid sequences to <a href="/ddbj/index-e.html">DDBJ</a> through the <a href="/ddbj/mss-e.html">Mass Submission System (MSS)</a>.</p>
<p>In the MSS submission, you will need to:
<ul>
  <li>Prepare sequences in <a href="/ddbj/mss-e.html#flow-2">fasta files and metadata in annotation files</a> as submission files.</li>
  <li>Check the submission files by using the <a href="/ddbj/mss-e.html#Check_submission_files">MSS checking tool</a>.</li>
...
`,ja:""}},{title:{en:"NSSS",ja:"NSSS"},body:{en:`<p>Submit small-scale (less than 500 sequences and/or shorter than 500kb) organelle sequences to <a href="/ddbj/index-e.html">DDBJ</a> through the <a href="/ddbj/web-submission-e.html">Nucleotide Sequence Submission System (NSSS)</a>.</p>
<p>In the NSSS submission, you will need to:
<ul>
  <li>Select an annotation template and describe annotation.</li>
  <li>Input sequences in the fasta format.</li>
...
`,ja:""}},{title:{en:"MSS",ja:"MSS"},body:{en:`<p>Submit large-scale (more than 500 sequences and/or longer than 500kb) organelle sequences to <a href="/ddbj/index-e.html">DDBJ</a> through the <a href="/ddbj/mss-e.html">Mass Submission System (MSS)</a>.</p>
<p>In the MSS submission, you will need to:
<ul>
...
`,ja:""}},{title:{en:"NSSS",ja:"NSSS"},body:{en:`<p>Submit small-scale (less than 500 sequences and/or shorter than 500kb) virus sequences to <a href="/ddbj/index-e.html">DDBJ</a> through the <a href="/ddbj/web-submission-e.html">Nucleotide Sequence Submission System (NSSS)</a>.</p>
<p>In the NSSS submission, you will need to:
<ul>
  <li>Select an annotation template and describe annotation.</li>
  <li>Input sequences in the fasta format.</li>
...
`,ja:""}},{title:{en:"MSS",ja:"MSS"},body:{en:`<p>Submit large-scale (more than 500 sequences and/or longer than 500kb) virus sequences to <a href="/ddbj/index-e.html">DDBJ</a> through the <a href="/ddbj/mss-e.html">Mass Submission System (MSS)</a>.</p>
<p>In the MSS submission, you will need to:
<ul>
  <li>Prepare sequences in <a href="/ddbj/mss-e.html#flow-2">fasta files and metadata in annotation files</a> as submission files.</li>
  <li>Check the submission files by using the <a href="/ddbj/mss-e.html#Check_submission_files">MSS checking tool</a>.</li>
