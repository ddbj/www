 ...
 */const P={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},c=s=>(...e)=>({_$litDirective$:s,values:e});class f{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,a,i){this._$Ct=e,this._$AM=a,this._$Ci=i}_$AS(e,a){return this.update(e,a)}update(e,a){return this.render(...a)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class b extends f{constructor(e){if(super(e),this.it=p,e.type!==P.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===p||e==null)return this.vt=void 0,this.it=e;if(e===S)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.vt;this.it=e;const a=[e];return a.raw=a,this.vt={_$litType$:this.constructor.resultType,strings:a,values:[]}}}b.directiveName="unsafeHTML",b.resultType=1;const M=c(b);class x extends f{render(){}update(e){e.element.scrollTo({top:0,left:0,behavior:"instant"})}}var T=c(x),k={"q1-yes->g-jga":{sections:[{title:{en:"Overview",ja:"\u6982\u8981"},body:{en:`<p>Submit human genetic and phenotypic data requiring controlled-access to the <a href="/jga/submission-step-e.html">Japanese Genotype-phenotype Archive (JGA)</a>. You need to submit a data submission application to the <a href="https://humandbs.biosciencedbc.jp/en/data-submission">NBDC</a> and the application needs to be approved before submitting the data to JGA. Regarding submission and sharing of human data, see the <a href="/policies-e.html#submission-of-human-data">Data submission of human subjects research</a>.</p>
<ol>
...
`}}]},ja:null};const I=k;function G(s){const e=I[s];if(!e)throw new Error(`goal not found: id=${s}`);return e}const N=y`:host{--max-height:calc(100vh - 2em)}.container{display:grid;grid-template:"header     header" auto "nav        content" 1fr/min-content 1fr;max-height:var(--max-height)}.container>h1{grid-area:header}.container>nav{grid-area:nav;text-align:center}.container>main{grid-area:content;overflow:auto}.space-between{display:flex;justify-content:space-between}.no-margin-around-y>:first-child{margin-top:0;padding-top:0}.no-margin-around-y>:last-child{margin-bottom:0;padding-bottom:0}.tabs>a{display:block;padding:calc(.5em / 1.2) calc(1.75em / 1.2);border-style:solid;border-color:transparent;border-width:3px 0;transition:background-color .2s,border-color .2s}.tabs>a:hover:not(.active){background-color:#eee}.tabs>a.active{border-bottom-color:#ff7370;text-decoration:none;color:inherit;font-weight:700}svg.icon{height:1em;width:1em;vertical-align:-.1em}`;var C=Object.defineProperty,_=Object.getOwnPropertyDescriptor,o=(s,e,a,i)=>{for(var n=i>1?void 0:i?_(e,a):e,m=s.length-1,h;m>=0;m--)(h=s[m])&&(n=(i?h(e,a,n):h(n))||n);return i&&n&&C(e,a,n),n},g=(s,e,a)=>{if(!e.has(s))throw TypeError("Cannot "+a)},j=(s,e,a)=>(g(s,e,"read from private field"),a?a.call(s):e.get(s)),E=(s,e,a)=>{if(e.has(s))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(s):e.set(s,a)},J=(s,e,a,i)=>(g(s,e,"write to private field"),i?i.call(s,a):e.set(s,a),a),l;let t=class extends w(v){constructor(){super(...arguments);E(this,l,void 0)}get section(){return j(this,l)||this.goal?.sections[0]}set section(s){const e=j(this,l);J(this,l,s),this.requestUpdate("section",e)}get previousSection(){const{goal:s,section:e}=this;if(!s||!e)return;const a=s.sections.indexOf(e);return a<=0?void 0:s.sections[a-1]}get nextSection(){const{goal:s,section:e}=this;if(!s||!e)return;const a=s.sections.indexOf(e);return a===-1||a>=s.sections.length?void 0:s.sections[a+1]}render(){const{goal:s}=this;return s?r`<div class="container border fade"><h1 class="box bg-primary my-0 font-large">${F} ${d("Submission Instructions")}</h1><nav class="box tabs font-heading font-large">${s.sections.map(e=>r`<a @click="${this.selectSection(e)}" class="${this.section===e?"active":""}" href="#">${this.localize(e.title)}</a>`)}</nav><main ${T()} class="box stack">${this.sectionTemplate()}</main></div>`:""}sectionTemplate(){if(!this.section)return"";const{body:s}=this.section;return r`<div class="no-margin-around-y">${M(this.localize(s))}</div><nav class="space-between"><div>${this.sectionLinkTemplate(`\xAB ${d("Prev")}`,this.previousSection)}</div><div>${this.sectionLinkTemplate(`${d("Next")} \xBB`,this.nextSection)}</div></nav>`}sectionLinkTemplate(s,e){return e?r`<a @click="${this.selectSection(e)}" href="#">${s}</a>`:""}selectSection(s){return e=>{e.preventDefault(),this.section=s}}};l=new WeakMap,t.styles=[D,N],o([A({converter:O})],t.prototype,"goal",2),o([u()],t.prototype,"section",1),o([u()],t.prototype,"previousSection",1),o([u()],t.prototype,"nextSection",1),t=o([R(),q("submission-wizard-goal")],t);function O(s){return s?G(s):void 0}const F=B`<svg class="icon" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M39 9.75V16.1786C39 18.2496 32.2843 19.9286 24 19.9286C15.7157 19.9286 9 18.2496 9 16.1786V9.75C9 7.67893 15.7157 6 24 6C32.2843 6 39 7.67893 39 9.75ZM9.62114 19.7144C11.4651 21.2634 17.2049 22.393 24 22.393C30.7951 22.393 36.5349 21.2634 38.3789 19.7144C38.783 20.0538 39 20.4134 39 20.7857V27.2143C39 29.2853 32.2843 30.9643 24 30.9643C15.7157 30.9643 9 29.2853 9 27.2143V20.7858C9.00002 20.4135 9.21703 20.0538 9.62114 19.7144ZM24 33.6786C17.205 33.6786 11.4652 32.549 9.62118 31C9.21703 31.3395 9 31.6991 9 32.0714V38.5C9 40.5711 15.7157 42.25 24 42.25C32.2843 42.25 39 40.5711 39 38.5V32.0714C39 31.6991 38.783 31.3395 38.3788 31C36.5348 32.549 30.795 33.6786 24 33.6786ZM32.3333 37.3333C32.3333 37.9777 31.811 38.5 31.1667 38.5C30.5223 38.5 30 37.9777 30 37.3333C30 36.689 30.5223 36.1667 31.1667 36.1667C31.811 36.1667 32.3333 36.689 32.3333 37.3333ZM35.8333 37.3333C36.4777 37.3333 37 36.811 37 36.1667C37 35.5223 36.4777 35 35.8333 35C35.189 35 34.6667 35.5223 34.6667 36.1667C34.6667 36.811 35.189 37.3333 35.8333 37.3333Z" fill="#333333"/></svg>`;export{t as SubmissionWizardGoal};
