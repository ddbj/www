import{T as d,b as v,r as f,L as g,p as r,m as j,s as E,e as y,t as S,a as A,l as Q,n as x}from"./submission-wizard-9284352d.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const D={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},c=t=>(...e)=>({_$litDirective$:t,values:e});class q{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,i,a){this._$Ct=e,this._$AM=i,this._$Ci=a}_$AS(e,i){return this.update(e,i)}update(e,i){return this.render(...i)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class l extends q{constructor(e){if(super(e),this.it=d,e.type!==D.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===d||e==null)return this.vt=void 0,this.it=e;if(e===v)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.vt;this.it=e;const i=[e];return i.raw=i,this.vt={_$litType$:this.constructor.resultType,strings:i,values:[]}}}l.directiveName="unsafeHTML",l.resultType=1;const V=c(l);class I extends q{render(){}update(e){e.element.scrollTo({top:0,left:0,behavior:"instant"})}}var O=c(I),N={"q5-genome-eukaryote-complete-dra->g-bp-bs-dra":{sections:[{title:{en:"Overview",ja:"\u6982\u8981"},body:{en:`<h1>data-from: q5-genome-eukaryote-complete-dra</h1>
...
`,ja:null}}]}};const R=N;function C(t){const e=R[t];if(!e)throw new Error(`goal not found: id=${t}`);return e}const M=f`:host{--max-height:calc(100vh - 2rem)}.scroll-container{display:flex;flex-direction:column;max-height:var(--max-height)}.scroll-pane{height:100%;box-sizing:border-box;overflow-y:auto;flex:1}.tabs{border-bottom:solid thin var(--border-light-color)}.tabs.cluster{gap:0}.tabs>a{padding:.5rem 2rem;text-decoration:none;transition:background-color .2s}.tabs>a:hover:not(.active){background-color:#eee}.tabs>a.active{border-bottom:solid 3px #ff7370;color:inherit;font-weight:700}`;var P=Object.defineProperty,B=Object.getOwnPropertyDescriptor,m=(t,e,i,a)=>{for(var u=a>1?void 0:a?B(e,i):e,s=t.length-1,p;s>=0;s--)(p=t[s])&&(u=(a?p(e,i,u):p(u))||u);return a&&u&&P(e,i,u),u},h=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},b=(t,e,i)=>(h(t,e,"read from private field"),i?i.call(t):e.get(t)),w=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},k=(t,e,i,a)=>(h(t,e,"write to private field"),a?a.call(t,i):e.set(t,i),i),o;let n=class extends g(A){constructor(){super(...arguments);w(this,o,void 0)}get section(){return b(this,o)||this.goal?.sections?.[0]}set section(t){const e=b(this,o);k(this,o,t),this.requestUpdate("section",e)}render(){const{goal:t}=this;return t?r`<section class="border scroll-container fade"><h1 class="box bg-primary my-0 font-large">📋 ${j("Submission Instructions")}</h1><nav class="tabs cluster font-heading font-large">${t.sections.map(e=>r`<a @click="${this.selectSection(e)}" class="${this.section===e?"active":""}" href="#">${this.localize(e.title)}</a>`)}</nav>${this.sectionTemplate()}</section>`:""}sectionTemplate(){if(!this.section)return"";const{body:t}=this.section;return r`<main ${O()} class="scroll-pane box-x">${V(this.localize(t))}</main>`}selectSection(t){return e=>{e.preventDefault(),this.section=t}}};o=new WeakMap,n.styles=[E,M],m([y({converter:T})],n.prototype,"goal",2),m([S()],n.prototype,"section",1),n=m([Q(),x("submission-wizard-goal")],n);function T(t){return t?C(t):void 0}export{n as SubmissionWizardGoal};
