...
AGD は NBDC でデータ提供を承認された匿名化されたデータだけを受け付けています ([ヒトを対象とした研究データの登録について](/policies.html#submission-of-human-data))。登録者は [NBDC](https://gr-sharingdbs.biosciencedbc.jp/agd-data-submission) に AGD へのデータ提供を申請し， NBDC からデータ提供の承認連絡を受けた登録者は [AGD に連絡](/contact-ddbj.html)します。
