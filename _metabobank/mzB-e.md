...
With the use of this format, all of MetaboBank's raw data (135 study, total data size: 1240GB, August 2024) were reduced to 217GB, 17.5% of the original data size. Similarly, the MS imaging raw data (1 study, total data size: 95GB, August 2024) were reduced to 4GB, 4.3% of the original data size.  
