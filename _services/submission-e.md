...
genes, and so on (collectively means "<span class="bold">registration
information</span>" of the entry).
...
<span class="#red">only submitters of the entry can revise and/or update
the entry</span>, it depends on the submitters of the entry if the entry
...
[gene](/ddbj/qualifiers-e.html#gene) and so on, arbitrarily.
  ...
  - Notice: protein coding sequence; CDS feature should have gene and
    product.  
...
### 1 Data Submission
  ...
  - (B) Mass Submission System (MSS)  
    We recommend the use of [Mass Submission System
    (MSS)](/ddbj/mss-e.html) if:
...
|                             |                                                                     |
| --------------------------- | ------------------------------------------------------------------- |
| For general inquiry on DDBJ | [Contact form](/contact-e.html#to-ddbj)                             |
| For data submission         | [Contact form](/contact-e.html#to-ddbj)                             |
| For updating submitted data | [Application Form for Data Update Requests](/ddbj/updt-form-e.html) |
...
Following figure shows the dataflow from new submission to release and
update at DDBJ.
