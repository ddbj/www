...
## Terminated WWW Services {#web-services}

- [DDBJ Pipeline](#pipeline) (Service terminated）
- [GIB](#gib) (Service terminated: 2012.2）
- [GIB-V](#gib-v) (Service terminated: 2012.2）
- [GTPS](#gtps) (Service terminated: 2012.2）
- FASTA (Service terminated: 2010.3）
- [PSI-BLSAT](#psi-blast) (Service terminated: 2010.3）
- [SSEARCH](#ssearch) (Service terminated: 2010.3）
- [HMMPFAM](#hmmpfam) (Service terminated: 2010.3）
- H-Invitational Database CIB-DDBJ Flat File Server (Service terminated: 2009.12.31）
- SRS(Service terminated: 2008.12）
- [LIBRA](#libra) (Service terminated: 2008.11）
- [Lib score](#lib-score) (Service terminated: 2008.11）
- SQmatch (Service terminated: 2008.11）
- PDB Retriever (Service terminated: 2008.11）
- SSThread (Service terminated: 2007.2）
- CAMUS (Service terminated: 2007.02）
- S&W SEARCH (Service terminated: 2006.04）
- malign (Service terminated: 2005.9）

## Terminated E-mail Servers {#E-mail}
...
### DDBJ Pipeline {#pipeline}

- [DDBJ read annotation pipeline: a cloud computing-based pipeline for high-throughput analysis of next-generation sequencing data](https://www.ncbi.nlm.nih.gov/pubmed/23657089){: .title}<br>Nagasaki H, Mochizuki T, Kodama Y, Saruhashi S, Morizaki S, Sugawara H, Ohyanagi H, Kurata N, Okubo K, Takagi T, Kaminuma E, Nakamura Y.<br>DNA Res. 2013 Aug;20(4):383-90. Pubmed: [23657089](https://www.ncbi.nlm.nih.gov/pubmed/23657089)
