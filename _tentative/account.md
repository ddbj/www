...
{::nomarkdown}
{% include image.html url="books/hac01.jpg" caption="二種類の登録アカウント" %}
{:/}
...
{::nomarkdown}
{% include image.html url="books/account_1_new.png" caption="新規アカウントを作成" %}
{:/}

必要な情報を入力して [Continue\] をクリックします。

{::nomarkdown}
{% include image.html url="books/account_2.jpg" caption="アカウント情報の入力" %}
{:/}
...
{::nomarkdown}
{% include image.html url="books/account_3.jpg" caption="新規アカウントを予約" %}
{:/}
...
{::nomarkdown}
{% include image.html url="books/account_4.jpg" caption="パスワードを設定" %}
{:/}

{::nomarkdown}
{% include image.html url="books/initial.jpg" caption="アカウントから BioProject と BioSample に登録できます" %}
{:/}
...
[![]({{ site.baseurl }}/assets/images/books/win_key_1.jpg)]({{ site.baseurl }}/assets/images/books/win_key_1.jpg "PuTTY Key Generator パラメータ設定"){: .group1}
...
[![]({{ site.baseurl }}/assets/images/books/mac_key_1.jpg)]({{ site.baseurl }}/assets/images/books/mac_key_1.jpg "Mac ターミナルを起動"){: .group1}
...
[![]({{ site.baseurl }}/assets/images/books/mac_key_2.jpg)]({{ site.baseurl }}/assets/images/books/mac_key_2.jpg "フォルダへ移動"){: .group1}

"フォルダへ移動" ウィンドウでホーム直下の ".ssh" フォルダのパスを入力します。

[![]({{ site.baseurl }}/assets/images/books/mac_key_3.jpg)]({{ site.baseurl }}/assets/images/books/mac_key_3.jpg ".ssh フォルダまでのパスを入力"){: .group1}

公開鍵ファイル "id\_rsa.pub" が表示されます。

[![]({{ site.baseurl }}/assets/images/books/mac_key_4.jpg)]({{ site.baseurl }}/assets/images/books/mac_key_4.jpg ".ssh フォルダ中の公開鍵ファイル"){: .group1}
...
{::nomarkdown}
{% include image.html url="books/center.jpg" caption="center name を登録" %}
{:/}
...
{::nomarkdown}
{% include image.html url="books/keyregister.jpg" caption="公開鍵を登録" %}
{:/}

登録後，左上の "DRA" メニューから DRA にデータを登録することができます。

{::nomarkdown}
{% include image.html url="books/drasub.jpg" caption="DRA に登録することができるようになります" %}
{:/}
...
[![]({{ site.baseurl }}/assets/images/books/con_1.jpg)]({{ site.baseurl }}/assets/images/books/con_1.jpg "鍵のインポート"){: .group1}
...
[![]({{ site.baseurl }}/assets/images/books/con_3.jpg)]({{ site.baseurl }}/assets/images/books/con_3.jpg "鍵のインポート"){: .group1}
