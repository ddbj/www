...
<dd>The below three files, which were distributed from our anonymous FTP site:<br><a href="ftp://ftp.ddbj.nig.ac.jp/ddbj_database/mass/Oryzias_latipes_CON/" target="list">ftp://ftp.ddbj.nig.ac.jp/ddbj_database/mass/Oryzias_latipes_CON/</a>, contain the entries including the illegal CONTIG lines. <b>Please be careful not to use the three files.</b> At present, the three files were removed from the FTP site and replaced with the revised files.
<dd>

    <table>
        <tr>
            <td bgcolor="ffffcc"><a href="ftp://ftp.ddbj.nig.ac.jp/ddbj_database/mass/Oryzias_latipes_CON/" target="list">ftp://ftp.ddbj.nig.ac.jp/ddbj_database/mass/Oryzias_latipes_CON/</a><br>Oryzias_latipes_CON_060524_1.seq.gz<br>Oryzias_latipes_CON_060531_1.seq.gz<br>Oryzias_latipes_CON_060605_1.seq.gz</td>
        </tr>
    </table>
    ...
    <table>
        <tr>
            <td bgcolor="#ccffff">
                ...
                <ul>
                    <li>You can see the revised file list by <a href="ftp://ftp.ddbj.nig.ac.jp/ddbj_database/mass/Oryzias_latipes_CON/filelist.txt" target="list">clicking here.</a></li>
