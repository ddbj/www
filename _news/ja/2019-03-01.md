...
<div class="recruit">
    ...
    <dl>
        ...
        <dd>
            ...
            <ul class="disc bottom_space">
                <li>システム開発・運用担当の<a href="" /about/staff.html#db-development"">運用チーム</a>、<a href="" about/stafff.html#sc"">スパコンチーム</a>、内部管理システムユーザ（<a href=""about/staffff.html#db-construction"">キュレータ</a>）と共同でデータベースシステム（データ登録、管理、処理、アカウント認証等）を開発する。</li>
