...
![対象 Dataset の選択]({{ site.baseurl }}/assets/images/books/jgadown01.jpg "対象 Dataset の選択")
...
![メタデータとデータファイル]({{ site.baseurl }}/assets/images/books/jgadown03.jpg "メタデータとデータファイル")

Dataset
ディレクトリの左にある矢印をクリックし，含まれているデータ番号ディレクトリを展開することができます。データ番号ディレクトリやファイルを選択し，個別にダウンロードすることもできます。

![ファイル毎のダウンロード]({{ site.baseurl }}/assets/images/books/jgadown02.jpg "ファイル毎のダウンロード")
...
![JGA で公開されている Study 一覧]({{ site.baseurl }}/assets/images/books/jgadown04.jpg
"JGA で公開されている Study 一覧")

利用権限が付与されているDataset 番号を選択します。

![メタデータを閲覧する Dataset の選択]({{ site.baseurl }}/assets/images/books/jgadown05.jpg
"メタデータを閲覧する Dataset の選択")

JGA tool と同様，NBDC から通知される利用アカウントのユーザ ID とパスワードでログインします。

![利用アカウントでログイン]({{ site.baseurl }}/assets/images/books/jgadown06.jpg "利用アカウントでログイン")

ウェブサイト上でメタデータを閲覧することができます。

![ウェブサイト上でメタデータを閲覧]({{ site.baseurl }}/assets/images/books/jgadown07.jpg "ウェブサイト上でメタデータを閲覧")
...
![メタデータ閲覧サイトからのログアウト]({{ site.baseurl }}/assets/images/books/jgadown08.jpg "メタデータ閲覧サイトからのログアウト")
