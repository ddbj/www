...
<div id="header-top-right">
  ...
  - [Japanese](/ddbj/environmental.html)
...
Though frequently confused, <span class="red bold">the term,
...
cannot be grown in axenic culture).
  ...
  - Notes on environmental sample submission
      ...
      - Either [clone](/ddbj/qualifiers-e.html#clone),
        ...
        [submitter\_seqid](/ddbj/qualifiers-e.html#submitter_seqid)
...
<!-- end list -->
  ...
  - For large scale sequence data  
    For large scale sequencing studies, particularly derived fro NGS,
    please submit [BioProject](/bioproject/index-e.html) and
    ...
    individuals, depending on from genomes or from RNA transcripts, the
    data should be submitted as [Genome Project](/ddbj/genome-e.html) or
    [Transcriptome Project](/ddbj/transcriptome-e.html), respectively.
