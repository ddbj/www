...
[Haplotype](/ddbj/haplotype.html#bioproject) をまとまるアンブレラプロジェクトを登録する場合、配下にリンクする primary BioProject のアクセッション番号とその区別 (例 PRJDB1 Principal, PRJDB2 Alternate, PRJDB3 DRA) を記入します。
